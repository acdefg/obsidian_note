...
flowchart TD
    subgraph GPU_Memory_System
        ...
        MMU[MMU(or just a mux)]
    end

    subgraph Host_Interface
        PCIe[PCIe host controller<br/>(16 lanes to host)]
    end
    ...
    %% Annotations
    classDef notes fill:none,stroke:none,color:#555,font-style:italic;
    note1["massive BW, long latency, high power draw"]:::notes
    note2["... rest of GPU here!"]:::notes
    note3["not-so-massive BW, even longer latency!"]:::notes
