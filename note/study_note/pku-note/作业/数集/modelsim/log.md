...
# modelsim 直接仿真 testbrench 文件步骤
1. 打开 modelsim，新建一个工程
...
9. 在最下方的界面输入 run 50ns（根据作业程序可输入 50-100，不能输 100）
