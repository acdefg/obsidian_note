...
- 批次并行、Warp切换、SIMD锁步执行、predication、discard、覆盖掩码、深度写入等机制相互配合；
...
这里有一个小三角形的插图：****
![image-16|244x243](https://imag060625.oss-cn-beijing.aliyuncs.com/img/20260127204021332.png)
