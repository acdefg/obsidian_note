...
| **Total FLOPs **     | 1.46T    | 2.92T    | 5.84T    | 11.67T   | 14.59T   | 29.18T   | 72.96T   | 145.92T  | 291.84T  |
| **TFLOPS**           | **6.78** | **8.92** | **9.77** | **9.04** | **8.95** | **7.84** | **6.04** | **4.20** | **2.58** |
1. **总 FLOPs**：
$$\text{Total FLOPs} = 2 \cdot P \cdot T$$
2. **实际算力**：
$$\text{TFLOPS} = \frac{\text{Total FLOPs}}{\text{Time (s)} \times 10^{12}}$$
官方给出的 A100 数据：
