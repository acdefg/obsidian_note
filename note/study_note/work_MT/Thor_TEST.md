...
|**Input Frames**|**Time (s)**|**Memory (GB)**|**FPS**|**Total Tokens (T)(Based on 706x529)**|**Total FLOPs(2PT)**|**TFLOPS(Real Perf)**|
|---|---|---|---|---|---|---|
...
- **oken 数量估算 ($T$)**：
    基于您提供的单帧数据反推，确定在当前 336 像素左右的推理分辨率下，单帧图像产生的 Token 数约为 608 个。因此，总 Token 数 $T = \text{Frame\_Count} \times 608$。
